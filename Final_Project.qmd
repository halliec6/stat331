...
25% of the variation in the average healthcare spending can be explained by the average sugar consumed per year. This number is low, suggesting sugar consumption has little predictive power. 
...
model_fit <- data.frame(
  var_name = c("variance_response", "variance_fitted",
               "variance_residuals", "r_2_val"),
  vals = round(c(variance_response, variance_fitted,
           variance_residuals, r_2_val), 2)
)
